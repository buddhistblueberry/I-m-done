...
class TvViewModel : ViewModel() {
    ...
    private fun load() {
        viewModelScope.launch { _popular.value = repo.getPopularTV() }
        viewModelScope.launch { _airingToday.value = repo.getAiringToday() }
        viewModelScope.launch { _topRated.value = repo.getTopRatedTV() }
    }
